...
// – Створити 3 об’єкти які описують книги. Поля об’єкту : title ,pageCount, genre.
{
  ...
  let book1: Book = { title: 'A', pageCount: 25, genre: 'Фантастика' };
  let book2: Book = { title: 'B', pageCount: 125, genre: 'Мемуари' };
  let book3: Book = { title: 'C', pageCount: 225, genre: 'Казки' };
...

{
  ...
  let user1: IUser = { name: 'f', username: 'f', password: '123' };
  let user2: IUser = { name: 'g', username: 'g', password: '123' };
  let user3: IUser = { name: 'h', username: 'h', password: '123' };
  let user4: IUser = { name: 'i', username: 'i', password: '123' };
  let user5: IUser = { name: 'j', username: 'j', password: '123' };
