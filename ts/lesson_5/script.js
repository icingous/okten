...
// – створити функцію, яка обчислює та повертає площу прямокутника зі сторонами  а і б
{
    ...
    const circleCylinder = (r, h) => 2 * Math.PI * r * h + 2 * circleSquare(r);
    ...
    const writeList2 = (listItemText, listLength) => {
        document.write('<ul>');
    ...
    const writeArrayOfPrimitives = (arr) => {
        document.write('<ul>');
        for (const item of arr) {
