...
//   document.write('<div>#y7crMeFwHcS</div>');
// }
...
// for (let index = 0; index < 10; index++) {
// document.write(`<div>${index} - #y7crMeFwHcS</div>`);
// }
...
//         <img src="${product.image}" alt="${product.title}" class="product-image" width='200' loading="lazy">
// </div>`);
// }
