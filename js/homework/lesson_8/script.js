...
//   console.log({ item, isEqualToOriginal: item === testItems[i] })
// );
...
// const trueCinderella = console.log(prince.findCinderella(cinderellas));
// const trueCinderella2 = console.log(copies[0].findCinderella(cinderellas));
